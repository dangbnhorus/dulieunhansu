                                        ...
                                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                                            <div class="card-header"><h2 class="text-center font-weight-light my-4">Nhập thông tin</h2></div>
                                                ...
                                                <div class="form-floating mb-3">
                                                     <input class="form-control" id="" type="text" name="mnv" placeholder="..." required/>
                                                     <label for="mnv">Mã nhân viên:</label>
                                                </div>
                                                <div class="form-floating mb-3">
                                                <input class="form-control" id="" type="fullname" name="fullname" placeholder="..." required/>
                                                <label for="fullname">Họ và tên:</label>
                                                </div>
                                                <div class="form-floating mb-3">
                                                     <input class="form-control" id="" type="email" name="email" placeholder="..." required/>
                                                     <label for="email">Email:</label>
                                                </div>
                                                <div class="form-floating mb-3">
                                                <input class="form-control" id="" type="phone" name="phone" placeholder="..." required/>
                                                <label for="phone">Số điện thoại:</label>
                                                </div>
                                                <div class="form-floating mb-3">
                                                <input class="form-control" id="" type="diachi" name="diachi" placeholder="..." required/>
                                                <label for="diachi">Địa chỉ:</label>
                                                </div>
                                                <div class="form-floating mb-3" >
                                                    <p>Ngày sinh:
                                                    <input type="date" id="" name="ngaysinh" style="width: 171px; height: 40px;" required/>
                                                    &ensp;
                                                <select style="width: 171px;height: 40px;" type="text" name="bophan" placeholder=" " required>
                                                    ...
                                                    &ensp; 
                                                <select style="width: 171px;height: 40px;" type="text" name="chucdanh" placeholder=" " required>
                                                ...
                                                <br/>
                                                <center>
                                                    <button type="btn btn-primary" name="btn-save" style="width: 100px; height: 35px; background-color: #0B5ED7; color: white; border: 0px; border-radius: 3px; "><strong> Lưu </strong></button>
                                                </center>
                                            </form>
                                        </div>
                                    </div>
